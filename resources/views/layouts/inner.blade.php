    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                Phocus 
                <small style="font-size: 12px !important; font-weight:normal !important;">{{$user->Role()}}</small>
                </a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a href="#/admin/edit/{{$user->id}}">
                    	<img alt="" src="./resources/assets/custom/images/16200d6d3b17a1d68cfefb338842545e.jpg" width="26">
